  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'stat-blue-icon': 'hsl(var(--stat-blue-icon))',
        'stat-purple': 'hsl(var(--stat-purple))',
        'stat-purple-icon': 'hsl(var(--stat-purple-icon))',
        'stat-mint': 'hsl(var(--stat-mint))',
        'stat-mint-icon': 'hsl(var(--stat-mint-icon))',
        'stat-coral': 'hsl(var(--stat-coral))',
        'stat-coral-icon': 'hsl(var(--stat-coral-icon))',
